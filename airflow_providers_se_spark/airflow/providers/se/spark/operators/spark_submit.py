...
from airflow.providers.se.spark.hooks.spark_submit import SparkSubmitHookSE
...
class SparkSubmitOperatorSE(BaseOperator):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._hook: SparkSubmitHookSE | None = None
    ...
    def _get_hook(self) -> SparkSubmitHookSE:
        return SparkSubmitHookSE(
            conf=self._conf,
