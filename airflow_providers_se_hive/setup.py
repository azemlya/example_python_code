...
from airflow.providers.se.hive import (
    __version__ as provider_version,
    __author__ as provider_author,
)

setup(
    name="apache-airflow-providers-se-hive",
    version=provider_version,
    author=provider_author,
    packages=[
        "airflow.providers.se.hive",
        "airflow.providers.se.hive.hooks",
        "airflow.providers.se.hive.operators",
        "airflow.providers.se.hive.macros",
        "airflow.providers.se.hive.plugins",
        "airflow.providers.se.hive.sensors",
        "airflow.providers.se.hive.utils",
    ],
    long_description=open(join(dirname(__file__), "README.md")).read(),
    include_package_data=True,
    entry_points={
        "apache_airflow_provider": [
            "provider_info = airflow.providers.se.hive.get_provider_info:get_provider_info",
        ],
    },
    install_requires=[
