...
from airflow.providers.se.hooks.spark_submit import SparkSubmitHookSE


class SparkJDBCHookSE(SparkSubmitHookSE):
    """
    ...
    conn_name_attr = "spark_se_conn_id"
    default_conn_name = "spark_se_default"
    conn_type = "spark_se_jdbc"
    hook_name = "Spark SE JDBC"
