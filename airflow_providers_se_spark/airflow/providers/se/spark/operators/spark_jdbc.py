...
from airflow_se.utils import run_klist
from airflow_se.parse import parse_tgs
from airflow_se.db import TGSList

from airflow.providers.se.spark.hooks.spark_jdbc import SparkJDBCHookSE
from airflow.providers.se.spark.operators.spark_submit import SparkSubmitOperatorSE
from airflow.providers.se.spark.utils import krb_auth
...
class SparkJDBCOperatorSE(SparkSubmitOperatorSE):
    """
    Extend the SparkSubmitOperatorSE to perform data transfers to/from JDBC-based databases with Apache Spark.

     As with the SparkSubmitOperatorSE, it assumes that the "spark-submit" binary is available on the PATH.

    .. seealso::
        For more information on how to use this operator, take a look at the guide:
        :ref:`howto/operator:SparkJDBCOperatorSE`
    ...
    def __init__(
        self,
        *,
        spark_app_name: str = "airflow-spark-se-jdbc",
        spark_conn_id: str = "spark-se-default",
        ...
        **kwargs: Any,
        ...
        self._hook: SparkJDBCHookSE | None = None

    def execute(self, context: Context) -> None:
        """Call the SparkSubmitHookSE to run the provided spark job."""
        dp = krb_auth(context)
        if dp:
            # ===================================
            ...
            raise AirflowException("Missing authentication as owner the DAG")
    ...
    def _get_hook(self) -> SparkJDBCHookSE:
        return SparkJDBCHookSE(
